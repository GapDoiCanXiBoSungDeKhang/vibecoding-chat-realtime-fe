...
export const useMessageSocket = ({
  ...
  useEffect(() => {
    ...
    const groupEvents = [
      ...
      'group_member_left', 'group_role_changed',
      'group_dissolved',
    ];
    ...
    return () => {
      ...
      if (socket) {
        const allEvents = [
          ...arrivalEvents,
          'message_edited', 'message_deleted', 'message_reacted',
          'message_seen', 'message_pinned', 'message_unpinned',
          'message_forwarded', 'mention_received', 'announcement_created',
